...
export class MapComponent {
  ...
  onMarkerInit(marker) {
    ...
    // let markerCluster = new this.markerClusterer(this.map, this.markers, {
    //   imagePath: 'http://maps.google.com/mapfiles/ms/icons/blue-dot.png'
    // });
    // console.log('markerclusterer', markerCluster);
  }
}
